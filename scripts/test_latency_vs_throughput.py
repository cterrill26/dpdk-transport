...
for i, worker in enumerate(workers):
    ...
    worker_cmds = [
        ...
        "nohup sudo dpdk-transport/tests/latency-vs-throughput/x86_64-native-linuxapp-gcc/app/latency-vs-throughput -- -f addr.txt -n 10000 > out.txt 2>&1 &"
        ]
...
controller_cmds = [
    ...
    "sudo bash dpdk-transport/scripts/setup.sh",
    "cd dpdk-transport; make RTE_SDK=/home/ec2-user/dpdk-stable-19.11.14 RTE_TARGET=x86_64-native-linuxapp-gcc",
    "sudo dpdk-transport/tests/latency-vs-throughput/x86_64-native-linuxapp-gcc/app/latency-vs-throughput -- -f addr.txt -c -s 10000 -e 30000 -i 10000 | tee out.txt"
    ]
